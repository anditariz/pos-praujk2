  ...
  <div class="flex flex-col w-64 border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 transition-all duration-300">
      <div class="flex items-center justify-center h-16 px-4 border-b border-gray-200 dark:border-gray-700 animate-slideIn">
          <div class="flex items-center">
              <i class="fa-solid fa-cookie-bite text-xl mr-2 text-primary-blue"></i>
              <span class="text-xl font-semibold">Bite's Me</span>
          </div>
      </div>
          ...
          <nav class="flex-1 px-2 py-4 space-y-1">
            ...
            @endforeach
              ...
              <div class="animate-fadeIn" style="animation-delay: 0.4s;">
                  <a href="/logout" class="flex items-center px-4 py-2 text-sm font-medium rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 sidebar-item">
      ...
      <div class="p-4 border-t border-gray-200 dark:border-gray-700 animate-fadeIn" style="animation-delay: 0.6s;">
          <div class="flex items-center">
              ...
              <div class="ml-3">
                  <p class="text-sm font-medium">Bite's Me</p>
                  <p class="text-xs text-gray-500 dark:text-gray-400">Sharing Sweetness Love</p>
              </div>
          </div>
      </div>
  </div>
