...
<div class="flex flex-col lg:flex-row gap-6">
    ...
    <div class="flex-1">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm overflow-hidden">
            <!-- Products Header -->
            <div class="bg-gradient-to-r from-primary-blue/20 to-primary-blue/10 px-6 py-4 dark:border-gray-700 border-b">
    ...
    <div class="w-full lg:w-96">
        <div class="bg-white dark:bg-gray-800 divide-gray-200 dark:divide-gray-700 rounded-2xl shadow-sm overflow-hidden h-full flex flex-col">
            <!-- Cart Header -->
            <div class="bg-gradient-to-r from-primary-blue/20 to-primary-blue/10 px-6 py-4 dark:border-gray-700 border-b">
                <div class="flex justify-between items-center">
                    <h2 class="text-xl font-semibold text-gray-800 dark:text-white">
            ...
            <form action="{{ route('pos.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="flex-1 overflow-y-auto px-4 py-3" id="cart-items">
                    ...
                    <div class="text-center py-10">
                        <div class="mx-auto w-24 h-24 rounded-full bg-primary-blue/20 flex items-center justify-center mb-4">
                ...
                <!-- Cart Summary -->
                <div class="border-t p-4 bg-white dark:border-gray-700 dark:bg-gray-800 divide-gray-200 dark:divide-gray-700">
                    <div class="space-y-3 mb-4">
                        ...
                        <div class="space-y-3 mb-4">
                            <label for="cashInput" class="text-sm font-medium text-gray-600 dark:text-white">Cash:</label>
                            <input type="number" id="cashInput" class="w-full border rounded p-2 dark:bg-gray-700 dark:text-white" placeholder="Masukkan uang bayar">
                    
                            <!-- Tombol cepat -->
                            <div class="flex flex-wrap gap-2 mt-2">
                                <button type="button" class="quick-add px-3 py-1 bg-primary-blue text-white rounded" data-amount="2000">+2.000</button>
                                <button type="button" class="quick-add px-3 py-1 bg-primary-blue text-white rounded" data-amount="5000">+5.000</button>
                                <button type="button" class="quick-add px-3 py-1 bg-primary-blue text-white rounded" data-amount="10000">+10.000</button>
                                <button type="button" class="quick-add px-3 py-1 bg-primary-blue text-white rounded" data-amount="20000">+20.000</button>
                                <button type="button" class="quick-add px-3 py-1 bg-primary-blue text-white rounded" data-amount="50000">+50.000</button>
                                <button type="button" class="quick-add px-3 py-1 bg-primary-blue text-white rounded" data-amount="100000">+100.000</button>
                            </div>
                        </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="border-t border-gray-100 pt-3 mt-3">
                        ...
                        <div class="flex justify-between font-semibold mt-2 pt-2 border-t border-gray-100">
                            <span>Total:</span>
                            <span id="receipt-total" class="text-primary-blue/10">$0.00</span>
                        </div>
                    </div>
                </div>
