            ...
            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                ...
                @foreach ($datas as $data)
                    <tr class="table-row">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap"><img src="{{ asset('storage/'. $data->product_photo) }}" alt="" width="200"></td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                            ...
                            <button class="text-primary-blue hover:text-primary-blue/80 mr-3 transition-colors"><i class="fas fa-trash eg-modal-toogle" data-id="deleteProductModal{{$data->id}}"></i></button>
                            @endif
                            @if ($privilage[0]['update'])
                            <button class="text-primary-green hover:text-primary-green/80 transition-colors"><i class="fas fa-edit eg-modal-toogle" data-id="updateProductModal{{$data->id}}"></i></button>
                            @endif
                        </td>
                        @endif
                    </tr>
