@foreach ($datas as $data)
    <div id="createUserModal{{$data->id}}" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 modal">
                ...
                <form method="POST" action="{{ route('users.update', $data->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <input value="{{$data->name}}" id="name" name="name" type="text" placeholder="Input Name"
                                class="input-focus w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-primary-blue dark:bg-gray-700 ransition-all duration-200 input-focus">
                        </div>
                    </div>
    ...
    <div id="deleteUserModal{{$data->id}}" class="fixed inset-0 z-50 flex items-center justify-center modal bg-black bg-opacity-50 transition-opacity">
